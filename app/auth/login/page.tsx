...
import { GoogleIcon, FacebookIcon, KeyIcon, PhoneIcon } from "@/app/constant/image";
      ...
      <div className="relative py-10">
        <div className="bg-purple w-[1000px] h-[730px] rounded-3xl absolute z-10 ">
          <div className="flex flex-col px-28 pt-20 gap-10 ">
            ...
            />
            <InputField image={KeyIcon} placeholder="Enter your password" password />
          </div>
          <p className="text-xl text-right text-white mr-28 mt-2">
            Don't have account ?{" "}
            <Link href="/auth/signup"><span className="font-semibold hover:text-yellow">Sign up</span></Link>
          </p>
          ...
          <Button className="text-3xl w-[550px] h-[70px] ml-52 mt-10 bg-[#1877F2]">
            <Image src={FacebookIcon} alt="Facebook Icon" width={50} height={50} className="mr-5"/>
            <p className="mr-32 text-white">Continue with facebook</p>
          </Button>
          <Button className="bg-white text-3xl w-[550px] h-[70px] ml-52 mt-10">
            <Image src={GoogleIcon} alt="Google Icon" width={50} height={50} className="mr-5"/>
